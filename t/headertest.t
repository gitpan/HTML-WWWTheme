   ...
   <!--a spacer-->
	  ...
	  <TABLE CELLSPACING="0" CELLPADDING="0">
	    <TR>
	      <TD WIDTH="5"><IMG SRC="/WWW/images/blank.gif" ALT="" WIDTH="5" HEIGHT="1" VSPACE="3"></TD>
	      <TD WIDTH="120">
		<FONT SIZE="-1" FACE="TIMES NEW ROMAN, TIMES ROMAN, TIMES, SERIF"><a href="here.html">here</a><IMG SRC="/WWW/images/blank.gif" ALT="" 
                     WIDTH="120" HEIGHT="1" VSPACE="3"><BR><a href="there.html">there</a>
...
if ($@) 
  {
    ...
    print "figure it out yourself, email the results to chogan\@uvphys.phys.uvic.ca, \n";
